...
为方便高中生整理学科知识，Web 版新增以下工具：

- **可视化公式编辑器**：集成 MathLive，所见即所得编辑数学/物理公式，无需手写 LaTeX，支持虚拟键盘
- **化学公式工具**：点击元素和符号自由拼接化学式与方程式，支持下标/上标、反应箭头、条件标签、离子电荷，内置 20+ 高中化学方程式模板
- **物理公式模板**：30+ 高中物理公式模板（运动学/力学/电磁学/热学/波动光学），分类浏览一键插入
- **函数图像绘制**：输入函数表达式实时生成图像，支持调节范围/颜色，可插入为节点图片
- **学科标签**：内置 6 大学科（数学/物理/化学/生物/英语/语文）的预设标签，快速分类知识点
